...
const Footer = () => {
  return (
    ...
    <section className='lg:w-full mobile2:w-auto md:w-auto small-devices:w-auto  dark:bg-slate-900 small-devices:flex small-devices:flex-col bg-transparent items-center flex flex-row justify-center h-[10px] '>

  ...
  return (
    <>
     {showMessageBox && (
      ...
      <section id="contact" className="dark:bg-slate-900 pb-1 small-devices:flex small-devices:flex-col small-devices:justify-center">
        <center>
        ...
        <div className="container-fluid">
          <div className='lg:w-full flex gap-5 justify-around flex-row flex-wrap small-devices:gap-[72px]'>
            ...
            <span className='small-devices:mt-[50px] dark:bg-slate-900  small-devices:ml-[10px] small-devices:mr-[10px]  pt-[22px] pb-8 '>

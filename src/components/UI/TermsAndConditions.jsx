...
const TermsAndConditions = () => {
  return (
    <div className="bg-white  dark:bg-gray-800 text-gray-800 dark:text-white py-10 mb-12 sm:pb-12 px-4 lg:px-24">
      <div className="max-w-3xl mx-auto">
        ...
        <p className="mb-4">
          The term 'Jagadeesh - Web Developer' or 'us' or 'we' refers to the owner of the website whose registered/operational
          office is No 10 Thirunavukarasu street, Annai Indra nagar, selaiyur, Chitlapakkam, Chennai Chennai TAMIL NADU 600073.
        ...
        <p className="mb-4">
          Your use of any information or materials on this website is entirely at your own risk, for which we shall not be liable. It shall
        ...
        <p className="mb-4">
          ...
          look, appearance and graphics. Reproduction is prohibited other than in accordance with the copyright notice, which forms part of these
        ...
        <p className="mb-4">
          You may not create a link to this website from another website or document without Jagadeesh - Web Developer’s prior written consent.
        </p>
        ...
        <p className="mb-4">
          We as a merchant shall be under no liability whatsoever in respect of any loss or damage arising directly or indirectly out of the decline
          of authorization for any Transaction, on Account of the Cardholder having exceeded the preset limit mutually agreed by us with our acquiring
